...
def upload():
    ...
    global crop_dataset
    global le
    filename = filedialog.askdirectory(initialdir = ".csv")
    rainfall_dataset = pd.read_csv(r'C:\Users\win11\OneDrive\Desktop\Crop\Crop-Yield-Prediction-using-Machine-Learning-Algorithms\dataset\district wise rainfall normal.csv')
    crop_dataset = pd.read_csv(r'C:\Users\win11\OneDrive\Desktop\Crop\Crop-Yield-Prediction-using-Machine-Learning-Algorithms\dataset\Agriculture In India.csv')
...
def runRNN():
    ...
    global weight_for_0
    global weight_for_1
    if os.path.exists(r'C:\Users\win11\OneDrive\Desktop\Crop\Crop-Yield-Prediction-using-Machine-Learning-Algorithms\model\rnnmodel.json'):
        with open(r'C:\Users\win11\OneDrive\Desktop\Crop\Crop-Yield-Prediction-using-Machine-Learning-Algorithms\model\rnnmodel.json', "r") as json_file:
            loaded_model_json = json_file.read()
            classifier = model_from_json(loaded_model_json)
        classifier.load_weights(r"C:\Users\win11\OneDrive\Desktop\Crop\Crop-Yield-Prediction-using-Machine-Learning-Algorithms\model\rnnmodel_weights.h5")
        classifier._make_predict_function()   
        print(classifier.summary())
        f = open(r'C:\Users\win11\OneDrive\Desktop\Crop\Crop-Yield-Prediction-using-Machine-Learning-Algorithms\model\rnnhistory.pckl', 'rb')
        data = pickle.load(f)
        f.close()
        accuracy = data[1] * 100
        rnn_acc = accuracy
        ...
        acc = values[1] * 100
        rnn_acc = acc
        f = open(r'C:\Users\win11\OneDrive\Desktop\Crop\Crop-Yield-Prediction-using-Machine-Learning-Algorithms\model\rnnhistory.pckl', 'wb')
        pickle.dump(values, f)
        f.close()
        text.insert(END,'RNN Prediction Accuracy : '+str(acc)+"\n\n")
        classifier = rnn
        classifier.save_weights(r'C:\Users\win11\OneDrive\Desktop\Crop\Crop-Yield-Prediction-using-Machine-Learning-Algorithms\model\rnnmodel_weights.h5',"r")
...
def runLSTM():
    global lstm_acc
    if os.path.exists(r'C:\Users\win11\OneDrive\Desktop\Crop\Crop-Yield-Prediction-using-Machine-Learning-Algorithms\model\lstmmodel.json'):
        with open(r'C:\Users\win11\OneDrive\Desktop\Crop\Crop-Yield-Prediction-using-Machine-Learning-Algorithms\model\lstmmodel.json', "r") as json_file:
            loaded_model_json = json_file.read()
            classifier1 = model_from_json(loaded_model_json)
        classifier1.load_weights(r"C:\Users\win11\OneDrive\Desktop\Crop\Crop-Yield-Prediction-using-Machine-Learning-Algorithms\model\lstmmodel_weights.h5")
        classifier1._make_predict_function()   
        print(classifier1.summary())
        f = open(r'C:\Users\win11\OneDrive\Desktop\Crop\Crop-Yield-Prediction-using-Machine-Learning-Algorithms\model\lstmhistory.pckl', 'rb')
        data = pickle.load(f)
        f.close()
        accuracy = data[1] * 100
        lstm_acc = accuracy
        ...
        model.add(tensorflow.keras.LSTM(512,input_shape=(X.shape[1], 1))) #defining LSTM layer in sequential object
        ...
        acc = values[1] * 100
        lstm_acc = acc
        f = open(r'C:\Users\win11\OneDrive\Desktop\Crop\Crop-Yield-Prediction-using-Machine-Learning-Algorithms\model\lstmhistory.pckl', 'wb')
        pickle.dump(values, f)
        f.close()
        text.insert(END,'LSTM Prediction Accuracy : '+str(acc)+"\n\n")
        classifier1 = model
        classifier1.save_weights(r'C:\Users\win11\OneDrive\Desktop\Crop\Crop-Yield-Prediction-using-Machine-Learning-Algorithms\model\lstmmodel_weights.h5')
        model_json = classifier1.to_json()
        with open(r"C:\Users\win11\OneDrive\Desktop\Crop\Crop-Yield-Prediction-using-Machine-Learning-Algorithms\model\lstmmodel.json", "w") as json_file:
            json_file.write(model_json)
...
def predict():
    ...
    print(test.shape)
    text.insert(END,"Bihar,SIWAN,2001,Kharif,Moong(Green Gram),4"+str())
    #classifier = model_from_json(r"C:\Users\win11\OneDrive\Desktop\Crop\Crop-Yield-Prediction-using-Machine-Learning-Algorithms\model\rnnmodel.json")
    classifier.load_weights(r"C:\Users\win11\OneDrive\Desktop\Crop\Crop-Yield-Prediction-using-Machine-Learning-Algorithms\model\lstmmodel_weights.h5")
    classifier._make_predict_function() 
...
def topGraph():
    ...
    rice = pd.read_csv(r'C:\Users\win11\OneDrive\Desktop\Crop\Crop-Yield-Prediction-using-Machine-Learning-Algorithms\dataset\Agriculture In India.csv')
...
font = ('times', 15, 'bold')
title = Label(main, text='Crop Yield Prediction using RNN Neural Network', justify=LEFT)
...
rnnButton = Button(main, text="clear", command=runRNN)
...
ffButton = Button(main, text="Run Recurrent Neural Network", command=runFF)
